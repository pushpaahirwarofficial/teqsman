...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="/admin_panel/review/create" class="active">
                    <i class="bx bx-grid-alt"></i>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            @endif
                ...
                <form action="{{ route('admin_panel.review.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                         <div class="col-md-6 mb-3">
                            <label for="description"class="mb-0">Main Review  (200 to 400 content required) :</label>
                            <input type="text" id="description" name="description" maxlength="400" required class="form-control">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-6 mb-3">
                            <label for="meta_key"class="mb-0">Meta Keywords:</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    descriptionInput.addEventListener('input', function() {
        ...
        charCount.textContent = `${currentLength}/400 characters used`;
    });
});
</script>
