...
@if(session('error'))
            ...
            @endif
                ...
                <form method="POST" action="{{ route('admin_panel.blog_show_update_store', ['id' => $blog->id]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="title_url" class="mb-0"> Blog Url:</label>
                            <input type="text" id="title_url" name="title_url" class="form-control" value="{{ $blog->title_url}}">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="meta_title" name="meta_title" required class="form-control" value="{{ $blog->meta_title}}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="meta_key" class="mb-0">Meta Key:</label>
                            <input type="text" id="meta_key" name="meta_key" class="form-control" value="{{ $blog->meta_key}}">
                        </div>
                       
                         <div class="col-md-6 mb-3">
                            <label for="meta_desc" class="mb-0">Meta Description:</label>
                            <input type="text" id="meta_desc" name="meta_desc" class="form-control" value="{{ $blog->meta_desc}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="category" name="category" class="form-control">
                                <option value="{{ $blog->category }}">{{ $blog->category ? $blog->category : 'None' }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <img src="{{ $blog->img_url }}" alt="Current Image" width="200">
                        </div>
                        <div class="col-md-6 mb-3" >
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="auth_name" name="auth_name" class="form-control" value="{{ $blog->auth_name }}">
                        </div>
